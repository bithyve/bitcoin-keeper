...
const char* start(const char* input_str, const char* private_key_str, const char* destination_addr_str, const char* pool_id, const char* denomination_str, const char* pre_user_hash_str, const char* network_str, const char* block_height_str);
