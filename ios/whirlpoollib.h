...
const char* tx0_preview(const int inputs_value, const char* pool_str, const double premix_fee_per_byte, const char* fees_address, const char* input_structure_str, const int miner_fee_per_byte, const int coordinator_fee, const char* n_wanted_max_outputs_str, const int n_pool_max_outputs);
