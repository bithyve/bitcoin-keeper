...
public class WhirlpoolBridge {
    ...
    public static native String tx0previewnew(Integer inputs_value, String poolStr, String premixFeePerByte, String feesAddress, String inputStructureStr, String minerFeePerByte,String coordinatorFee, String nWantedMaxOutputsStr, String nPoolMaxOutputs);
