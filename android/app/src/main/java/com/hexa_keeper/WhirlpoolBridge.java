...
public class WhirlpoolBridge {
    ...
    public static native String initiate(String port, String network);
    public static native String pools(String port, String network);
    public static native String gettx0data(String scode, String port, String network);
    ...
    public static native String tx0push(String txStr, String poolIdStr, String port, String network);
