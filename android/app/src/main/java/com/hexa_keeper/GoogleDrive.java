...
import static com.hexa_keeper.DriveServiceHelper.getGoogleDriveService;
...
public class GoogleDrive extends ReactContextBaseJavaModule {
    ...
    public void login(final Promise promise) {
        ...
        if(accougetDriveClientnt == null) {
            ...
            mDriveServiceHelper = new DriveServiceHelper(getGoogleDriveService(mContext.getApplicationContext(), accougetDriveClientnt, "keeper"));
    ...
    private void handleSignInResult(GoogleSignInResult result, Boolean isSilent) {
        if (result.isSuccess()) {
            ...
            mDriveServiceHelper = new DriveServiceHelper(getGoogleDriveService(mContext.getApplicationContext(), acct, "keeper"));
            setData(acct, true);
