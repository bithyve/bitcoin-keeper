        ...
        try {
           ...
           val defaultFont = Font(interRegular, 13f, Font.NORMAL)
            ...
            val footer = Paragraph("This document is generated by the Bitcoin Keeper app. Need help? Reach out to us via the in-app chat support called Keeper Concierge. For more details visit: www.bitcoinkeeper.app.   \n" +
                    ...
                    "** Keeper and Sparrow are bitcoin wallets that allow you to create wallets called multisig wallets. Multisig wallets, as the name suggests require multiple signatures to sign a single bitcoin transaction.", defaultFont)
