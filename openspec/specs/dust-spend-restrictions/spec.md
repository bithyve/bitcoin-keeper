# Dust Spend Restrictions Specification

## Purpose

The Dust Spend Restrictions domain governs how UTXOs marked as Do Not Spend are
handled during automatic and manual coin selection. It ensures that automatic
transaction construction never uses Do Not Spend UTXOs unless the user has
explicitly selected them, and that the balance displayed in the send flow
accurately reflects only spendable outputs.
