    ...
    return __generator(this, function (_g) {
      switch (_g.label) {
        ...
        case 3:
          ...
          return [
            4 /*yield*/,
            bleManager.connectedDevices((0, devices_1.getBluetoothServiceUuids)()),
          ];
        case 4:
        ...
        case 8:
          e_1 = _g.sent();
          if (!(e_1.errorCode === react_native_ble_plx_1.BleErrorCode.DeviceMTUChangeFailed))
            return [3 /*break*/, 10];
        ...
        case 18:
          e_2 = _g.sent();
          if (!(e_2.errorCode === react_native_ble_plx_1.BleErrorCode.DeviceMTUChangeFailed))
            return [3 /*break*/, 20];
          // eslint-disable-next-line require-atomic-updates
          connectOptions = {};
        ...
        case 35:
          ...
          notifyObservable = (0, monitorCharacteristic_1.monitorCharacteristic)(notifyC).pipe(
            ...
            (0, operators_1.tap)(function (value) {
              if (value instanceof errors_1.PairingFailed) return;
        ...
        case 38:
          ...
          return [
            4 /*yield*/,
            BluetoothTransport.disconnect(transport.id)['catch'](function () {}),
          ];
        case 39:
          // necessary time for the bonding workaround
          _g.sent();
          ...
          return __generator(this, function (_b) {
            switch (_b.label) {
              ...
              case 2:
                ...
                return [
                  4 /*yield*/,
                  bleManager.cancelDeviceConnection(this.id)['catch'](function () {}),
                ];
              case 3:
                // in such case we will always disconnect because something is bad.
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            ...
            case 1:
              ...
              return [
                4 /*yield*/,
                this.writeCharacteristic.writeWithResponse(buffer.toString('base64'), txid),
              ];
            case 2:
              _b.sent();
              return [3 /*break*/, 4];
            ...
            case 5:
              ...
              return [
                4 /*yield*/,
                this.writeCmdCharacteristic.writeWithoutResponse(buffer.toString('base64'), txid),
              ];
            case 6:
              _b.sent();
              return [3 /*break*/, 8];
        ...
        switch (_b.label) {
                        ...
                        return [
                          ...
                          (0, rxjs_1.merge)(
                            this.notifyObservable.pipe(
                              (0, operators_1.tap)(function (maybeError) {
                            ...
                            (0, rxjs_1.defer)(function () {
                              return (0, rxjs_1.from)(_this.write(Buffer.from([0x08, 0, 0, 0, 0])));
          ...
          case 1:
            ...
            if (mtu > 23) {
              ...
              (0, logs_1.log)(
                'ble-verbose',
                'BleTransport('.concat(String(this.id), ') mtu set to ').concat(String(mtuSize))
              );
