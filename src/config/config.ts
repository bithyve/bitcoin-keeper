...
class HexaConfig {
  ...
  public BH_SERVERS = {
    RELAY: Config.BIT_API_URLS_RELAY ? Config.BIT_API_URLS_RELAY.trim() : 'https://dev-relay.bithyve.com/',
  ...
  public HEXA_ID: string = Config.BIT_HEXA_ID ? Config.BIT_HEXA_ID.trim() : 'b01623f1065ba45d68b516efe2873f59bfc9b9b2d8b194f94f989d87d711830a';
  ...
  public connectToPersonalNode = async (personalNode: PersonalNode) => {
    ...
    if (personalNodeURL && personalNode.isConnectionActive) {
      ...
      this.USE_ESPLORA_FALLBACK = personalNode.useFallback ? personalNode.useFallback : false
    }
  }
