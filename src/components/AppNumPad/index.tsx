...
const AppNumPad = ({ ok, clear, setValue, disable = false, color = '#FDF7F0', height = 70 }) => {
    ...
    <View style={styles.numPadContainer}>
      {numPadArr.map((char) => {
        if ((char === 'ok') & ok) {
          ...
          return <CharButton Icon={<DeleteIcon />} pressHandler={onClear} key={char} color={color} height={height} />;
