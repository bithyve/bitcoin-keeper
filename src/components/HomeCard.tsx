  ...
  return (
    <View>
      <ImageBackground style={styles.homeCard} source={HomeCardImage}>
        {item?.last === 'true' ? <View style={styles.addWalletContainer}>
          <TouchableOpacity>
          <AddSCardIcon />
          </TouchableOpacity>
          <Text style={styles.addWalletText} color={'light.white'} fontFamily={'body'} fontWeight={'300'}>Add Wallet</Text>
        </View> :
          <>
            ...
            <View style={styles.walletContainer}>
              ...
              <Text style={styles.walletName} color={'light.white'} fontFamily={'body'} fontWeight={'100'}>{item?.icontitle}</Text>
            </View>
