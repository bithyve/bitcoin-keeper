...
function SetupColdCard({ route }) {
  ...
  const instructions = isConfigRecovery
    ...
    : 'Export the zPub by going to Advanced/Tools > Export wallet > Generic JSON. From here choose the account number and transfer over NFC. Make sure you remember the account you had chosen (This is important for recovering your Vault).\n';
  return (
