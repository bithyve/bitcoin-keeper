...
class HexaConfig {
  ...
  public EJECTED_ACCOUNTS = [ DerivativeAccountTypes.SUB_PRIMARY_ACCOUNT, DerivativeAccountTypes.DONATION_ACCOUNT, DerivativeAccountTypes.WYRE, DerivativeAccountTypes.RAMP, DerivativeAccountTypes.SWAN ];
