...
const DEFAULT_CONFIG = {
  ...
  REMOTE_KEY_PASSWORD: '1209d64234bc4e42a1fd3d2726306380eb579d7015fa47139aea14497cf3d723b',
};
...
class Configuration {
  ...
  public REMOTE_KEY_PASSWORD: string = config.REMOTE_KEY_PASSWORD
    ? config.REMOTE_KEY_PASSWORD
    : DEFAULT_CONFIG.REMOTE_KEY_PASSWORD;
