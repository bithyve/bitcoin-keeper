    ...
    <body>
      <div class="container">
        <div class="page">
          ...
          <p>** Keeper and Sparrow are bitcoin wallets that allow you to create wallets called multisig wallets (In Keeper these are called Vaults). Multisig wallets, as the name suggests, require multiple signatures to sign a single bitcoin transaction.</p>
        </div>
