...
<body>
    <div class="container">
        ...
        <h1 class="title">Additional Key Details Template</h1>
        <p>Additional Key Details - Can be used in any m-of-n combination to create one or more vaults <span class="multi-line">(multi-key wallets)</span></p>
        <div class="keys">
            <div class="key-container">
                <div class="key-heading">Key 1</div>
                <div class="key">
                    <p class="marginBottom">Fingerprint:</p>
                    <p class="marginBottom">Type:</p>
                    <p class="marginBottom">PIN:</p>
                    <p class="marginBottomTwice">Location:</p>
                    <p class="marginBottom">Software Version:</p>
                </div>
            </div>
            <div class="key-container">
                <div class="key-heading">Key 2</div>
                <div class="key">
                    <p class="marginBottom">Fingerprint:</p>
                    <p class="marginBottom">Type:</p>
                    <p class="marginBottom">PIN:</p>
            ...
            <div class="key-container">
                <div class="key-heading">Key 3</div>
                <div class="key">
                    <p class="marginBottom">Fingerprint:</p>
                    <p class="marginBottom">Type:</p>
                    <p class="marginBottom">PIN:</p>
            ...
            <div class="key-container">
                <div class="key-heading">Key 4</div>
                <div class="key">
                    <p class="marginBottom">Fingerprint:</p>
                    <p class="marginBottom">Type:</p>
                    <p class="marginBottom">PIN:</p>
    ...
    <div class="container">
        ...
        <div class="keys">
            <div class="key-container">
                <div class="key-heading">Key 5</div>
                <div class="key">
                    <p class="marginBottom">Fingerprint:</p>
                    <p class="marginBottom">Type:</p>
                    <p class="marginBottom">PIN:</p>
            ...
            <div class="key-container">
                <div class="key-heading">Key 6</div>
                <div class="key">
                    <p class="marginBottom">Fingerprint:</p>
                    <p class="marginBottom">Type:</p>
                    <p class="marginBottom">PIN:</p>
            ...
            <div class="key-container">
                <div class="key-heading">Key 7</div>
                <div class="key">
                    <p class="marginBottom">Fingerprint:</p>
                    <p class="marginBottom">Type:</p>
                    <p class="marginBottom">PIN:</p>
            ...
            <div class="key-container">
                <div class="key-heading">Key 8</div>
                <div class="key">
                    <p class="marginBottom">Fingerprint:</p>
                    <p class="marginBottom">Type:</p>
                    <p class="marginBottom">PIN:</p>
